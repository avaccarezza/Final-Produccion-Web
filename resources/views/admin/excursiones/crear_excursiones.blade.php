        ...
        <div class="col-auto">
            <div class="user_card">
                <div class="d-flex justify-content-center form_container">
                    <form class="form" action="<?= route("excursiones.store") ?>" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="<?= csrf_token() ?>">
                        <div class="subtit">
                            <h2>Crear Excursion</h2>
                        </div> 
                       
    
                            <div class="d-flex justify-content-center mt-3 login_container">
                                <input type="text" class="form-control" name="nombre" id="nom-exc" placeholder="Nombre de Excursion" >                               
                        </div>
                           ...
                           <div id="textarea" class="d-flex justify-content-center mt-3 login_container">
                            <input type="text" class="form-control" name="precio" id="nom-exc" placeholder="Precio" >
                            </div>
                        ...
                        <div class="mt-4">
                            <div class="d-flex justify-content-center mt-3 login_container">
                                <button class="boton1" type="submit" >Crear Excursion</button>
